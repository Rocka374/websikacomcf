 ...
 * Автор: Websika Team
 * Версия: 1.2 - Добавен fallback за reveal анимации
 * 
 * Съдържание:
 * 1. Mobile навигация
 * 2. Sticky header
 * 3. Scroll reveal анимации с fallback
 * 4. 3D tilt cards
 * 5. Floating blobs
...
(function() {
  ...
  function initScrollReveal() {
    if (REDUCED_MOTION) {
      // Ако потребителят предпочита намалени движения, покажи всичко веднага
    ...
    // Fallback: ако IntersectionObserver не е наличен, покажи всичко веднага
    if (!('IntersectionObserver' in window)) {
      revealElements.forEach(el => {
        el.classList.add('active');
      });
      console.warn('IntersectionObserver не е наличен. Reveal анимациите са деактивирани.');
      return;
    }
    ...
    // Безопасност: след 1.5 секунди, ако все още има неактивни reveal елементи, ги активирай
    setTimeout(() => {
